    ...
    <div class="row" style="height: 100%">
     <div class="col-md-3">
      <div href="#" class="d-inline">
       <img src="<?php echo $user_details["profile_img"] ?>" width="130px" style="margin: 0" /><br />
       <p class="pl-2 mt-2">
      ...
      <div>
       <form action="" method="post">
        <div class="form-group">
         ...
         <input type="text" class="form-control" name="id" readonly="readonly" value="<?php echo $user_details["id"] ?>" placeholder="First Name" required />
        </div>
        <div class="form-group">
         <label for="fullName">Full Name</label>
         <input type="text" class="form-control" name="fullname" id="first_name" value="<?php echo $user_details["full_name"] ?>" placeholder="First Name" required />
        </div>
        <div class="form-group">
         <label for="email">Email</label>
         <input type="email" class="form-control" name="email" id="email" value="<?php echo $user_details["email"] ?>" />
        </div>
        <div class="form-group">
