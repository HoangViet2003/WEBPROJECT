...
<head>
  ...
  <link rel="stylesheet" href="css/images-upload.css" />
...
<body>
  ...
  <div class="main-content-wrapper d-flex clearfix">
    ...
    <header class="header-area clearfix">
      ...
      <nav class="amado-nav">
        <ul>
          ...
          <li class="<?php if ($current_page == 'shop.php') : echo 'active';
                      ...
                      endif; ?> "><a href="shop.php">Shop</a></li>
          <!-- <li><a href="product-details.html">Product</a></li> -->
          <li class="<?php if ($current_page == 'cart.php') : echo 'active';
                      else : echo '';
                      endif; ?> "><a href="cart.php">Cart</a></li>
          <!-- <li class="<?php if ($current_page == 'checkout.php') : echo 'active';
                          else : echo '';
                          endif; ?> "><a href="checkout.php">Checkout</a></li> -->
          <?php
          if (isset($_SESSION['useremail'])) : ?>
            <li class="<?php if ($current_page == 'profile.php') : echo 'active';
                        else : echo '';
                        endif; ?> "><a href="profile.php">My profile</a></li>
      ...
      $numCartItems = count($cart->getAllProductsFromCart($_SESSION['cart_id']));

      ?>
      <div class="cart-fav-search mb-100">
        <a href="cart.php" class="cart-nav"><img src="img/core-img/cart.png" alt="" /> Cart <span>(<?php echo $numCartItems ?>)</span></a>
