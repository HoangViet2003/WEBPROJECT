                ...
                <div class="col-md-12">
                    <form action="" id="productform" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="id" id="product_id_label">ID (cannot change this field)</label><input type="text" class="form-control" id="product_id" name="id" value="" readonly />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="" id="product_category" name="category" style="float: none !important">
                        ...
                        <div class="row">
                            <div class="row mt-5">
                                ...
                                <div class="col">
                                    <a id="delete-btn" class="btn amado-btn active" name="delete" onclick="deleteProduct()" style="color: white">
                                        Delete
                                    </a>
                                </div>
                            </div>
...
<script src="{{ asset('assets/js/api/Admin/productDetail.js') }}" defer></script>
@endsection