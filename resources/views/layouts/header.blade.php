        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <header class="header-area clearfix">
                ...
                <nav class="amado-nav">
                    <ul>
                        <li
                            class="<?php if ($current_page == 'index.php') : echo 'active'; else : echo ''; endif; ?>"
                        >
                            <a href="index.php">Home</a>
                        </li>
                        <li
                            class="<?php if ($current_page == 'shop.php') : echo 'active'; else : echo ''; endif; ?>"
                        >
                            <a href="shop.php">Shop</a>
                        </li>
                        <!-- <li><a href="product-details.html">Product</a></li> -->
                        <li
                            class="<?php if ($current_page == 'cart.php') : echo 'active'; else : echo ''; endif; ?>"
                        >
          ...
          if (isset($_SESSION['useremail'])) : ?>
                        <li
                            class="<?php if ($current_page == 'profile.php') : echo 'active'; else : echo ''; endif; ?>"
                        >
