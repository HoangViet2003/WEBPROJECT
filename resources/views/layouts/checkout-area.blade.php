          ...
          <form action="#" method="post">
            <div class="row">
              <div class="col-12 mb-3">
                <input type="text" class="form-control" id="full_name"  placeholder="First Name" required readonly />
              </div>
              <div class="col-12 mb-3">
          ...
          <div class="payment-method">
            ...
            <div class="custom-control custom-checkbox mr-sm-2">
              ...
              <label class="custom-control-label" for="paypal">Paypal
                <img class="ml-15" src="{{asset('assets/img/core-img/paypal.png')}}" alt="" /></label>
            </div>
          </div>

          <div class="cart-btn mt-100">
            <a href="#" onclick="createOrder()" class="btn amado-btn w-100">Checkout</a>
          </div>
        </div>
      </div>
    </div>
