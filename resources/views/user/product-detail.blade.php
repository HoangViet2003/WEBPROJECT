                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mt-50">
                            ...
                            <li class="breadcrumb-item active" aria-current="page" id="product-title"></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-7">
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators" id="product-image-slide"></ol>
                ...
                <div class="col-12 col-lg-5">
                    <div class="single_product_desc">
                        ...
                        <form class="cart clearfix" id="add-cart-form">
                            ...
                            <button class="btn amado-btn" id="btn-add" type="submit">
                                Add to cart
                            </button>
